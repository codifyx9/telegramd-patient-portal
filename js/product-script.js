class HLDProduct {
  ...
  initImageSlider() {
    const slider = document.querySelector("[data-hld-image-slider]");
    if (!slider) return;

    const cards = slider.children;
    const prevBtn = document.querySelector(".hld-image-arrow--left");
    const nextBtn = document.querySelector(".hld-image-arrow--right");
